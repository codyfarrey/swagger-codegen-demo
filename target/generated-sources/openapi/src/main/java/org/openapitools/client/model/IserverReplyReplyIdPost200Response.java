...
public class IserverReplyReplyIdPost200Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(IserverReplyReplyIdPost200Response.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IserverReplyReplyIdPost200Response.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'IserverReplyReplyIdPost200Response' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<IserverReplyReplyIdPost200Response>() {
                @Override
                public void write(JsonWriter out, IserverReplyReplyIdPost200Response value) throws IOException {
                ...
                @Override
                public IserverReplyReplyIdPost200Response read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        IserverReplyReplyIdPost200Response ret = new IserverReplyReplyIdPost200Response();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for IserverReplyReplyIdPost200Response: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public IserverReplyReplyIdPost200Response() {
        super("oneOf", Boolean.FALSE);
    }

    public IserverReplyReplyIdPost200Response(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return IserverReplyReplyIdPost200Response.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to IserverReplyReplyIdPost200Response
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for IserverReplyReplyIdPost200Response with oneOf schemas: AdvancedOrderReject, List<OrderReplyMessageInner>, List<OrderSubmitSuccessInner>, OrderSubmitError. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of IserverReplyReplyIdPost200Response given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IserverReplyReplyIdPost200Response
     * @throws IOException if the JSON string is invalid with respect to IserverReplyReplyIdPost200Response
     */
    public static IserverReplyReplyIdPost200Response fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, IserverReplyReplyIdPost200Response.class);
    }

    /**
     * Convert an instance of IserverReplyReplyIdPost200Response to an JSON string
     *
     * @return JSON string
     */
