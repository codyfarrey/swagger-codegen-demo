...
public class QueryRecurringInstructionsResult {
  public static final String SERIALIZED_NAME_ACCOUNT_ID = "accountId";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_ID)
  @javax.annotation.Nonnull
  private String accountId;

  public static final String SERIALIZED_NAME_RECURRING_INSTRUCTIONS = "recurringInstructions";
  @SerializedName(SERIALIZED_NAME_RECURRING_INSTRUCTIONS)
  @javax.annotation.Nonnull
  private List<Object> recurringInstructions = new ArrayList<>();
  ...
  public QueryRecurringInstructionsResult() {
  }

  public QueryRecurringInstructionsResult accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public QueryRecurringInstructionsResult recurringInstructions(@javax.annotation.Nonnull List<Object> recurringInstructions) {
    this.recurringInstructions = recurringInstructions;
    return this;
  }

  public QueryRecurringInstructionsResult addRecurringInstructionsItem(Object recurringInstructionsItem) {
    if (this.recurringInstructions == null) {
      this.recurringInstructions = new ArrayList<>();
    }
    this.recurringInstructions.add(recurringInstructionsItem);
    return this;
  }

  /**
   * Get recurringInstructions
   * @return recurringInstructions
   */
  @javax.annotation.Nonnull
  public List<Object> getRecurringInstructions() {
    return recurringInstructions;
  }

  public void setRecurringInstructions(@javax.annotation.Nonnull List<Object> recurringInstructions) {
    this.recurringInstructions = recurringInstructions;
  }


  public QueryRecurringInstructionsResult clientInstructionId(@javax.annotation.Nonnull String clientInstructionId) {
  ...
  public QueryRecurringInstructionsResult instructionType(@javax.annotation.Nonnull InstructionTypeEnum instructionType) {
  ...
  public QueryRecurringInstructionsResult instructionStatus(@javax.annotation.Nonnull InstructionStatusEnum instructionStatus) {
  ...
  public QueryRecurringInstructionsResult instructionId(@javax.annotation.Nonnull BigDecimal instructionId) {
  ...
  public QueryRecurringInstructionsResult ibReferenceId(@javax.annotation.Nullable BigDecimal ibReferenceId) {
  ...
  public QueryRecurringInstructionsResult description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    QueryRecurringInstructionsResult queryRecurringInstructionsResult = (QueryRecurringInstructionsResult) o;
    return Objects.equals(this.accountId, queryRecurringInstructionsResult.accountId) &&
        Objects.equals(this.recurringInstructions, queryRecurringInstructionsResult.recurringInstructions) &&
        Objects.equals(this.clientInstructionId, queryRecurringInstructionsResult.clientInstructionId) &&
        Objects.equals(this.instructionType, queryRecurringInstructionsResult.instructionType) &&
        Objects.equals(this.instructionStatus, queryRecurringInstructionsResult.instructionStatus) &&
        Objects.equals(this.instructionId, queryRecurringInstructionsResult.instructionId) &&
        Objects.equals(this.ibReferenceId, queryRecurringInstructionsResult.ibReferenceId) &&
        Objects.equals(this.description, queryRecurringInstructionsResult.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, recurringInstructions, clientInstructionId, instructionType, instructionStatus, instructionId, ibReferenceId, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QueryRecurringInstructionsResult {\n");
    sb.append("    accountId: ").append(toIndentedString(accountId)).append("\n");
    sb.append("    recurringInstructions: ").append(toIndentedString(recurringInstructions)).append("\n");
  ...
  static {
    ...
    openapiRequiredFields.add("recurringInstructions");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryRecurringInstructionsResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryRecurringInstructionsResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryRecurringInstructionsResult is not found in the empty JSON string", QueryRecurringInstructionsResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryRecurringInstructionsResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryRecurringInstructionsResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueryRecurringInstructionsResult.openapiRequiredFields) {
      ...
      if (!jsonObj.get("recurringInstructions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `recurringInstructions` to be an array in the JSON string but got `%s`", jsonObj.get("recurringInstructions").toString()));
      }

      JsonArray jsonArrayrecurringInstructions = jsonObj.getAsJsonArray("recurringInstructions");
      // validate the required field `recurringInstructions` (array)
      for (int i = 0; i < jsonArrayrecurringInstructions.size(); i++) {
        Object.validateJsonElement(jsonArrayrecurringInstructions.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryRecurringInstructionsResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryRecurringInstructionsResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryRecurringInstructionsResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryRecurringInstructionsResult.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryRecurringInstructionsResult>() {
           @Override
           public void write(JsonWriter out, QueryRecurringInstructionsResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryRecurringInstructionsResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryRecurringInstructionsResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryRecurringInstructionsResult
   * @throws IOException if the JSON string is invalid with respect to QueryRecurringInstructionsResult
   */
  public static QueryRecurringInstructionsResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryRecurringInstructionsResult.class);
  }

  /**
   * Convert an instance of QueryRecurringInstructionsResult to an JSON string
   *
   * @return JSON string
   */
