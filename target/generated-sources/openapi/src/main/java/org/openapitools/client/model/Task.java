...
public class Task {
  ...
  public Task formNumber(@javax.annotation.Nullable Integer formNumber) {
  ...
  public Task status(@javax.annotation.Nullable Boolean status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    Task task = (Task) o;
    return Objects.equals(this.formNumber, task.formNumber) &&
        Objects.equals(this.status, task.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formNumber, status);
  }
