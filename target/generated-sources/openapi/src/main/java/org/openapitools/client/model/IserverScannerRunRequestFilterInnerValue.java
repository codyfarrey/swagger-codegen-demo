...
public class IserverScannerRunRequestFilterInnerValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(IserverScannerRunRequestFilterInnerValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!IserverScannerRunRequestFilterInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'IserverScannerRunRequestFilterInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<IserverScannerRunRequestFilterInnerValue>() {
                @Override
                public void write(JsonWriter out, IserverScannerRunRequestFilterInnerValue value) throws IOException {
                ...
                @Override
                public IserverScannerRunRequestFilterInnerValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        IserverScannerRunRequestFilterInnerValue ret = new IserverScannerRunRequestFilterInnerValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for IserverScannerRunRequestFilterInnerValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public IserverScannerRunRequestFilterInnerValue() {
        super("oneOf", Boolean.FALSE);
    }

    public IserverScannerRunRequestFilterInnerValue(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return IserverScannerRunRequestFilterInnerValue.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to IserverScannerRunRequestFilterInnerValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for IserverScannerRunRequestFilterInnerValue with oneOf schemas: BigDecimal, Boolean, Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of IserverScannerRunRequestFilterInnerValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of IserverScannerRunRequestFilterInnerValue
     * @throws IOException if the JSON string is invalid with respect to IserverScannerRunRequestFilterInnerValue
     */
    public static IserverScannerRunRequestFilterInnerValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, IserverScannerRunRequestFilterInnerValue.class);
    }

    /**
     * Convert an instance of IserverScannerRunRequestFilterInnerValue to an JSON string
     *
     * @return JSON string
     */
