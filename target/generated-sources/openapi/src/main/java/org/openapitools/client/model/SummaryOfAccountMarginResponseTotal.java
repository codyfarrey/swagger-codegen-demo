...
public class SummaryOfAccountMarginResponseTotal {
  ...
  public SummaryOfAccountMarginResponseTotal() {
  }

  public SummaryOfAccountMarginResponseTotal currentInitial(@javax.annotation.Nullable String currentInitial) {
  ...
  public SummaryOfAccountMarginResponseTotal prdctdPstXpryMrgnAtOpn(@javax.annotation.Nullable String prdctdPstXpryMrgnAtOpn) {
  ...
  public SummaryOfAccountMarginResponseTotal currentMaint(@javax.annotation.Nullable String currentMaint) {
  ...
  public SummaryOfAccountMarginResponseTotal projectedLiquidityInitalMargin(@javax.annotation.Nullable String projectedLiquidityInitalMargin) {
  ...
  public SummaryOfAccountMarginResponseTotal prjctdLkAhdMntnncMrgn(@javax.annotation.Nullable String prjctdLkAhdMntnncMrgn) {
  ...
  public SummaryOfAccountMarginResponseTotal projectedOvernightInitialMargin(@javax.annotation.Nullable String projectedOvernightInitialMargin) {
  ...
  public SummaryOfAccountMarginResponseTotal prjctdOvrnghtMntnncMrgn(@javax.annotation.Nullable String prjctdOvrnghtMntnncMrgn) {
  ...
  public boolean equals(Object o) {
    ...
    SummaryOfAccountMarginResponseTotal summaryOfAccountMarginResponseTotal = (SummaryOfAccountMarginResponseTotal) o;
    return Objects.equals(this.currentInitial, summaryOfAccountMarginResponseTotal.currentInitial) &&
        Objects.equals(this.prdctdPstXpryMrgnAtOpn, summaryOfAccountMarginResponseTotal.prdctdPstXpryMrgnAtOpn) &&
        Objects.equals(this.currentMaint, summaryOfAccountMarginResponseTotal.currentMaint) &&
        Objects.equals(this.projectedLiquidityInitalMargin, summaryOfAccountMarginResponseTotal.projectedLiquidityInitalMargin) &&
        Objects.equals(this.prjctdLkAhdMntnncMrgn, summaryOfAccountMarginResponseTotal.prjctdLkAhdMntnncMrgn) &&
        Objects.equals(this.projectedOvernightInitialMargin, summaryOfAccountMarginResponseTotal.projectedOvernightInitialMargin) &&
        Objects.equals(this.prjctdOvrnghtMntnncMrgn, summaryOfAccountMarginResponseTotal.prjctdOvrnghtMntnncMrgn);
  }
  ...
  public String toString() {
    ...
    sb.append("class SummaryOfAccountMarginResponseTotal {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SummaryOfAccountMarginResponseTotal
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SummaryOfAccountMarginResponseTotal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SummaryOfAccountMarginResponseTotal is not found in the empty JSON string", SummaryOfAccountMarginResponseTotal.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SummaryOfAccountMarginResponseTotal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SummaryOfAccountMarginResponseTotal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SummaryOfAccountMarginResponseTotal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SummaryOfAccountMarginResponseTotal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SummaryOfAccountMarginResponseTotal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SummaryOfAccountMarginResponseTotal.class));

       return (TypeAdapter<T>) new TypeAdapter<SummaryOfAccountMarginResponseTotal>() {
           @Override
           public void write(JsonWriter out, SummaryOfAccountMarginResponseTotal value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SummaryOfAccountMarginResponseTotal read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SummaryOfAccountMarginResponseTotal given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SummaryOfAccountMarginResponseTotal
   * @throws IOException if the JSON string is invalid with respect to SummaryOfAccountMarginResponseTotal
   */
  public static SummaryOfAccountMarginResponseTotal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SummaryOfAccountMarginResponseTotal.class);
  }

  /**
   * Convert an instance of SummaryOfAccountMarginResponseTotal to an JSON string
   *
   * @return JSON string
   */
