...
public class IRADecedent {
  ...
  /**
   * Gets or Sets inheritorType
   */
  @JsonAdapter(InheritorTypeEnum.Adapter.class)
  public enum InheritorTypeEnum {
    S("S"),
    ...
    InheritorTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static InheritorTypeEnum fromValue(String value) {
      for (InheritorTypeEnum b : InheritorTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<InheritorTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final InheritorTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public InheritorTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return InheritorTypeEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      InheritorTypeEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_INHERITOR_TYPE = "inheritorType";
  @SerializedName(SERIALIZED_NAME_INHERITOR_TYPE)
  @javax.annotation.Nullable
  private InheritorTypeEnum inheritorType;
  ...
  public IRADecedent name(@javax.annotation.Nullable IndividualName name) {
    this.name = name;
    return this;
  }
  ...
  public IRADecedent nativeName(@javax.annotation.Nullable IndividualName nativeName) {
  ...
  public IRADecedent birthName(@javax.annotation.Nullable IndividualName birthName) {
  ...
  public IRADecedent motherMaidenName(@javax.annotation.Nullable IndividualName motherMaidenName) {
  ...
  public IRADecedent dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public IRADecedent countryOfBirth(@javax.annotation.Nullable String countryOfBirth) {
  ...
  public IRADecedent cityOfBirth(@javax.annotation.Nullable String cityOfBirth) {
  ...
  public IRADecedent gender(@javax.annotation.Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public IRADecedent maritalStatus(@javax.annotation.Nullable MaritalStatusEnum maritalStatus) {
  ...
  public IRADecedent numDependents(@javax.annotation.Nullable Integer numDependents) {
  ...
  public IRADecedent residenceAddress(@javax.annotation.Nullable ResidenceAddress residenceAddress) {
  ...
  public IRADecedent mailingAddress(@javax.annotation.Nullable Address mailingAddress) {
  ...
  public IRADecedent phones(@javax.annotation.Nullable List<PhoneInfo> phones) {
    this.phones = phones;
    return this;
  }

  public IRADecedent addPhonesItem(PhoneInfo phonesItem) {
    if (this.phones == null) {
  ...
  public IRADecedent email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public IRADecedent identification(@javax.annotation.Nullable Identification identification) {
  ...
  public IRADecedent employmentType(@javax.annotation.Nullable String employmentType) {
  ...
  public IRADecedent employmentDetails(@javax.annotation.Nullable EmploymentDetails employmentDetails) {
  ...
  public IRADecedent employeeTitle(@javax.annotation.Nullable String employeeTitle) {
  ...
  public IRADecedent taxResidencies(@javax.annotation.Nullable List<TaxResidency> taxResidencies) {
    this.taxResidencies = taxResidencies;
    return this;
  }

  public IRADecedent addTaxResidenciesItem(TaxResidency taxResidenciesItem) {
  ...
  public IRADecedent w9(@javax.annotation.Nullable FormW9 w9) {
    this.w9 = w9;
    return this;
  }
  ...
  public IRADecedent w8Ben(@javax.annotation.Nullable FormW8BEN w8Ben) {
    this.w8Ben = w8Ben;
    return this;
  }
  ...
  public IRADecedent crs(@javax.annotation.Nullable FormCRS crs) {
    this.crs = crs;
    return this;
  }
  ...
  public IRADecedent prohibitedCountryQuestionnaire(@javax.annotation.Nullable ProhibitedCountryQuestionnaireList prohibitedCountryQuestionnaire) {
  ...
  public IRADecedent id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public IRADecedent externalId(@javax.annotation.Nullable String externalId) {
  ...
  public IRADecedent userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public IRADecedent sameMailAddress(@javax.annotation.Nullable Boolean sameMailAddress) {
  ...
  public IRADecedent authorizedToSignOnBehalfOfOwner(@javax.annotation.Nullable Boolean authorizedToSignOnBehalfOfOwner) {
  ...
  public IRADecedent authorizedTrader(@javax.annotation.Nullable Boolean authorizedTrader) {
  ...
  public IRADecedent usTaxResident(@javax.annotation.Nullable Boolean usTaxResident) {
  ...
  public IRADecedent translated(@javax.annotation.Nullable Boolean translated) {
  ...
  public IRADecedent primaryTrustee(@javax.annotation.Nullable Boolean primaryTrustee) {
  ...
  public IRADecedent dateOfDeath(@javax.annotation.Nullable LocalDate dateOfDeath) {
  ...
  public void setDateOfDeath(@javax.annotation.Nullable LocalDate dateOfDeath) {
    this.dateOfDeath = dateOfDeath;
  }


  public IRADecedent title(@javax.annotation.Nullable Title title) {
    this.title = title;
    return this;
  }
  ...
  public IRADecedent inheritorType(@javax.annotation.Nullable InheritorTypeEnum inheritorType) {
   ...
   */
  @javax.annotation.Nullable
  public InheritorTypeEnum getInheritorType() {
    return inheritorType;
  }

  public void setInheritorType(@javax.annotation.Nullable InheritorTypeEnum inheritorType) {
    this.inheritorType = inheritorType;
  }


  public IRADecedent relationship(@javax.annotation.Nullable RelationshipEnum relationship) {
  ...
  public boolean equals(Object o) {
    ...
    IRADecedent irADecedent = (IRADecedent) o;
    return Objects.equals(this.name, irADecedent.name) &&
        Objects.equals(this.nativeName, irADecedent.nativeName) &&
        Objects.equals(this.birthName, irADecedent.birthName) &&
        Objects.equals(this.motherMaidenName, irADecedent.motherMaidenName) &&
        Objects.equals(this.dateOfBirth, irADecedent.dateOfBirth) &&
        Objects.equals(this.countryOfBirth, irADecedent.countryOfBirth) &&
        Objects.equals(this.cityOfBirth, irADecedent.cityOfBirth) &&
        Objects.equals(this.gender, irADecedent.gender) &&
        Objects.equals(this.maritalStatus, irADecedent.maritalStatus) &&
        Objects.equals(this.numDependents, irADecedent.numDependents) &&
        Objects.equals(this.residenceAddress, irADecedent.residenceAddress) &&
        Objects.equals(this.mailingAddress, irADecedent.mailingAddress) &&
        Objects.equals(this.phones, irADecedent.phones) &&
        Objects.equals(this.email, irADecedent.email) &&
        Objects.equals(this.identification, irADecedent.identification) &&
        Objects.equals(this.employmentType, irADecedent.employmentType) &&
        Objects.equals(this.employmentDetails, irADecedent.employmentDetails) &&
        Objects.equals(this.employeeTitle, irADecedent.employeeTitle) &&
        Objects.equals(this.taxResidencies, irADecedent.taxResidencies) &&
        Objects.equals(this.w9, irADecedent.w9) &&
        Objects.equals(this.w8Ben, irADecedent.w8Ben) &&
        Objects.equals(this.crs, irADecedent.crs) &&
        Objects.equals(this.prohibitedCountryQuestionnaire, irADecedent.prohibitedCountryQuestionnaire) &&
        Objects.equals(this.id, irADecedent.id) &&
        Objects.equals(this.externalId, irADecedent.externalId) &&
        Objects.equals(this.userId, irADecedent.userId) &&
        Objects.equals(this.sameMailAddress, irADecedent.sameMailAddress) &&
        Objects.equals(this.authorizedToSignOnBehalfOfOwner, irADecedent.authorizedToSignOnBehalfOfOwner) &&
        Objects.equals(this.authorizedTrader, irADecedent.authorizedTrader) &&
        Objects.equals(this.usTaxResident, irADecedent.usTaxResident) &&
        Objects.equals(this.translated, irADecedent.translated) &&
        Objects.equals(this.primaryTrustee, irADecedent.primaryTrustee) &&
        Objects.equals(this.dateOfDeath, irADecedent.dateOfDeath) &&
        Objects.equals(this.title, irADecedent.title) &&
        Objects.equals(this.inheritorType, irADecedent.inheritorType) &&
        Objects.equals(this.relationship, irADecedent.relationship);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, nativeName, birthName, motherMaidenName, dateOfBirth, countryOfBirth, cityOfBirth, gender, maritalStatus, numDependents, residenceAddress, mailingAddress, phones, email, identification, employmentType, employmentDetails, employeeTitle, taxResidencies, w9, w8Ben, crs, prohibitedCountryQuestionnaire, id, externalId, userId, sameMailAddress, authorizedToSignOnBehalfOfOwner, authorizedTrader, usTaxResident, translated, primaryTrustee, dateOfDeath, title, inheritorType, relationship);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IRADecedent {\n");
    ...
    sb.append("    inheritorType: ").append(toIndentedString(inheritorType)).append("\n");
  ...
  static {
    ...
    openapiFields.add("inheritorType");
   ...
   * @throws IOException if the JSON Element is invalid with respect to IRADecedent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!IRADecedent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IRADecedent is not found in the empty JSON string", IRADecedent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!IRADecedent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IRADecedent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("inheritorType") != null && !jsonObj.get("inheritorType").isJsonNull()) && !jsonObj.get("inheritorType").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `inheritorType` to be a primitive type in the JSON string but got `%s`", jsonObj.get("inheritorType").toString()));
      }
      // validate the optional field `inheritorType`
      if (jsonObj.get("inheritorType") != null && !jsonObj.get("inheritorType").isJsonNull()) {
        InheritorTypeEnum.validateJsonElement(jsonObj.get("inheritorType"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IRADecedent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IRADecedent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IRADecedent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IRADecedent.class));

       return (TypeAdapter<T>) new TypeAdapter<IRADecedent>() {
           @Override
           public void write(JsonWriter out, IRADecedent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IRADecedent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of IRADecedent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of IRADecedent
   * @throws IOException if the JSON string is invalid with respect to IRADecedent
   */
  public static IRADecedent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IRADecedent.class);
  }

  /**
   * Convert an instance of IRADecedent to an JSON string
   *
   * @return JSON string
   */
