...
import org.openapitools.client.model.DepositFundsPollingResultAllOfDepositDetails;
...
public class DepositFundsPollingResult {
  ...
  public static final String SERIALIZED_NAME_DEPOSIT_DETAILS = "depositDetails";
  @SerializedName(SERIALIZED_NAME_DEPOSIT_DETAILS)
  @javax.annotation.Nullable
  private DepositFundsPollingResultAllOfDepositDetails depositDetails;

  public DepositFundsPollingResult() {
  }

  public DepositFundsPollingResult clientInstructionId(@javax.annotation.Nonnull String clientInstructionId) {
  ...
  public DepositFundsPollingResult instructionType(@javax.annotation.Nonnull InstructionTypeEnum instructionType) {
  ...
  public DepositFundsPollingResult instructionStatus(@javax.annotation.Nonnull InstructionStatusEnum instructionStatus) {
  ...
  public DepositFundsPollingResult instructionId(@javax.annotation.Nonnull BigDecimal instructionId) {
  ...
  public DepositFundsPollingResult ibReferenceId(@javax.annotation.Nullable BigDecimal ibReferenceId) {
  ...
  public DepositFundsPollingResult description(@javax.annotation.Nullable String description) {
  ...
  public DepositFundsPollingResult error(@javax.annotation.Nullable PollingInstructionResultError error) {
    this.error = error;
    return this;
  }
  ...
  public DepositFundsPollingResult depositDetails(@javax.annotation.Nullable DepositFundsPollingResultAllOfDepositDetails depositDetails) {
   ...
   */
  @javax.annotation.Nullable
  public DepositFundsPollingResultAllOfDepositDetails getDepositDetails() {
    return depositDetails;
  }

  public void setDepositDetails(@javax.annotation.Nullable DepositFundsPollingResultAllOfDepositDetails depositDetails) {
    this.depositDetails = depositDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    DepositFundsPollingResult depositFundsPollingResult = (DepositFundsPollingResult) o;
    return Objects.equals(this.clientInstructionId, depositFundsPollingResult.clientInstructionId) &&
        Objects.equals(this.instructionType, depositFundsPollingResult.instructionType) &&
        Objects.equals(this.instructionStatus, depositFundsPollingResult.instructionStatus) &&
        Objects.equals(this.instructionId, depositFundsPollingResult.instructionId) &&
        Objects.equals(this.ibReferenceId, depositFundsPollingResult.ibReferenceId) &&
        Objects.equals(this.description, depositFundsPollingResult.description) &&
        Objects.equals(this.error, depositFundsPollingResult.error) &&
        Objects.equals(this.depositDetails, depositFundsPollingResult.depositDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientInstructionId, instructionType, instructionStatus, instructionId, ibReferenceId, description, error, depositDetails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DepositFundsPollingResult {\n");
  ...
  static {
    ...
    openapiFields.add("depositDetails");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DepositFundsPollingResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DepositFundsPollingResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DepositFundsPollingResult is not found in the empty JSON string", DepositFundsPollingResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DepositFundsPollingResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DepositFundsPollingResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DepositFundsPollingResult.openapiRequiredFields) {
      ...
      // validate the optional field `depositDetails`
      if (jsonObj.get("depositDetails") != null && !jsonObj.get("depositDetails").isJsonNull()) {
        DepositFundsPollingResultAllOfDepositDetails.validateJsonElement(jsonObj.get("depositDetails"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DepositFundsPollingResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DepositFundsPollingResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DepositFundsPollingResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DepositFundsPollingResult.class));

       return (TypeAdapter<T>) new TypeAdapter<DepositFundsPollingResult>() {
           @Override
           public void write(JsonWriter out, DepositFundsPollingResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DepositFundsPollingResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DepositFundsPollingResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DepositFundsPollingResult
   * @throws IOException if the JSON string is invalid with respect to DepositFundsPollingResult
   */
  public static DepositFundsPollingResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DepositFundsPollingResult.class);
  }

  /**
   * Convert an instance of DepositFundsPollingResult to an JSON string
   *
   * @return JSON string
   */
