...
public class DeleteRelationship {
  ...
  public DeleteRelationship name(@javax.annotation.Nullable NameEnum name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteRelationship deleteRelationship = (DeleteRelationship) o;
    return Objects.equals(this.name, deleteRelationship.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRelationship {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRelationship
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRelationship.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteRelationship is not found in the empty JSON string", DeleteRelationship.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRelationship.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteRelationship` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRelationship.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRelationship' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRelationship> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRelationship.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRelationship>() {
           @Override
           public void write(JsonWriter out, DeleteRelationship value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRelationship read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRelationship given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRelationship
   * @throws IOException if the JSON string is invalid with respect to DeleteRelationship
   */
  public static DeleteRelationship fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRelationship.class);
  }

  /**
   * Convert an instance of DeleteRelationship to an JSON string
   *
   * @return JSON string
   */
