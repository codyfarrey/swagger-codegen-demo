...
public class Individual {
  ...
  public Individual name(@javax.annotation.Nullable IndividualName name) {
    this.name = name;
    return this;
  }
  ...
  public Individual nativeName(@javax.annotation.Nullable IndividualName nativeName) {
  ...
  public Individual birthName(@javax.annotation.Nullable IndividualName birthName) {
  ...
  public Individual motherMaidenName(@javax.annotation.Nullable IndividualName motherMaidenName) {
  ...
  public Individual dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public Individual countryOfBirth(@javax.annotation.Nullable String countryOfBirth) {
  ...
  public Individual cityOfBirth(@javax.annotation.Nullable String cityOfBirth) {
  ...
  public Individual gender(@javax.annotation.Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public Individual maritalStatus(@javax.annotation.Nullable MaritalStatusEnum maritalStatus) {
  ...
  public Individual numDependents(@javax.annotation.Nullable Integer numDependents) {
  ...
  public Individual residenceAddress(@javax.annotation.Nullable ResidenceAddress residenceAddress) {
  ...
  public Individual mailingAddress(@javax.annotation.Nullable Address mailingAddress) {
  ...
  public Individual phones(@javax.annotation.Nullable List<PhoneInfo> phones) {
    this.phones = phones;
    return this;
  }

  public Individual addPhonesItem(PhoneInfo phonesItem) {
    if (this.phones == null) {
  ...
  public Individual email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public Individual identification(@javax.annotation.Nullable Identification identification) {
  ...
  public Individual employmentType(@javax.annotation.Nullable String employmentType) {
  ...
  public Individual employmentDetails(@javax.annotation.Nullable EmploymentDetails employmentDetails) {
  ...
  public Individual employeeTitle(@javax.annotation.Nullable String employeeTitle) {
  ...
  public Individual taxResidencies(@javax.annotation.Nullable List<TaxResidency> taxResidencies) {
    this.taxResidencies = taxResidencies;
    return this;
  }

  public Individual addTaxResidenciesItem(TaxResidency taxResidenciesItem) {
  ...
  public Individual w9(@javax.annotation.Nullable FormW9 w9) {
    this.w9 = w9;
    return this;
  }
  ...
  public Individual w8Ben(@javax.annotation.Nullable FormW8BEN w8Ben) {
    this.w8Ben = w8Ben;
    return this;
  }
  ...
  public Individual crs(@javax.annotation.Nullable FormCRS crs) {
    this.crs = crs;
    return this;
  }
  ...
  public Individual prohibitedCountryQuestionnaire(@javax.annotation.Nullable ProhibitedCountryQuestionnaireList prohibitedCountryQuestionnaire) {
  ...
  public Individual id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Individual externalId(@javax.annotation.Nullable String externalId) {
  ...
  public Individual userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public Individual sameMailAddress(@javax.annotation.Nullable Boolean sameMailAddress) {
  ...
  public Individual authorizedToSignOnBehalfOfOwner(@javax.annotation.Nullable Boolean authorizedToSignOnBehalfOfOwner) {
  ...
  public Individual authorizedTrader(@javax.annotation.Nullable Boolean authorizedTrader) {
  ...
  public Individual usTaxResident(@javax.annotation.Nullable Boolean usTaxResident) {
  ...
  public Individual translated(@javax.annotation.Nullable Boolean translated) {
  ...
  public Individual primaryTrustee(@javax.annotation.Nullable Boolean primaryTrustee) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, individual.name) &&
        Objects.equals(this.nativeName, individual.nativeName) &&
        Objects.equals(this.birthName, individual.birthName) &&
        Objects.equals(this.motherMaidenName, individual.motherMaidenName) &&
        Objects.equals(this.dateOfBirth, individual.dateOfBirth) &&
        Objects.equals(this.countryOfBirth, individual.countryOfBirth) &&
        Objects.equals(this.cityOfBirth, individual.cityOfBirth) &&
        Objects.equals(this.gender, individual.gender) &&
        Objects.equals(this.maritalStatus, individual.maritalStatus) &&
        Objects.equals(this.numDependents, individual.numDependents) &&
        Objects.equals(this.residenceAddress, individual.residenceAddress) &&
        Objects.equals(this.mailingAddress, individual.mailingAddress) &&
        Objects.equals(this.phones, individual.phones) &&
        Objects.equals(this.email, individual.email) &&
        Objects.equals(this.identification, individual.identification) &&
        Objects.equals(this.employmentType, individual.employmentType) &&
        Objects.equals(this.employmentDetails, individual.employmentDetails) &&
        Objects.equals(this.employeeTitle, individual.employeeTitle) &&
        Objects.equals(this.taxResidencies, individual.taxResidencies) &&
        Objects.equals(this.w9, individual.w9) &&
        Objects.equals(this.w8Ben, individual.w8Ben) &&
        Objects.equals(this.crs, individual.crs) &&
        Objects.equals(this.prohibitedCountryQuestionnaire, individual.prohibitedCountryQuestionnaire) &&
        Objects.equals(this.id, individual.id) &&
        Objects.equals(this.externalId, individual.externalId) &&
        Objects.equals(this.userId, individual.userId) &&
        Objects.equals(this.sameMailAddress, individual.sameMailAddress) &&
        Objects.equals(this.authorizedToSignOnBehalfOfOwner, individual.authorizedToSignOnBehalfOfOwner) &&
        Objects.equals(this.authorizedTrader, individual.authorizedTrader) &&
        Objects.equals(this.usTaxResident, individual.usTaxResident) &&
        Objects.equals(this.translated, individual.translated) &&
        Objects.equals(this.primaryTrustee, individual.primaryTrustee);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, nativeName, birthName, motherMaidenName, dateOfBirth, countryOfBirth, cityOfBirth, gender, maritalStatus, numDependents, residenceAddress, mailingAddress, phones, email, identification, employmentType, employmentDetails, employeeTitle, taxResidencies, w9, w8Ben, crs, prohibitedCountryQuestionnaire, id, externalId, userId, sameMailAddress, authorizedToSignOnBehalfOfOwner, authorizedTrader, usTaxResident, translated, primaryTrustee);
  }
