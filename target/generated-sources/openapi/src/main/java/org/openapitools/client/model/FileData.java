...
public class FileData {
  ...
  public FileData data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public FileData name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FileData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FileData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
