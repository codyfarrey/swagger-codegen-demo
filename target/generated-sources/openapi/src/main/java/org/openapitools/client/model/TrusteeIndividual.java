...
public class TrusteeIndividual {
  ...
  public static final String SERIALIZED_NAME_NFA_REGISTERED = "nfaRegistered";
  @SerializedName(SERIALIZED_NAME_NFA_REGISTERED)
  @javax.annotation.Nullable
  private Boolean nfaRegistered;

  public static final String SERIALIZED_NAME_NFA_REGISTRATION_NUMBER = "nfaRegistrationNumber";
  @SerializedName(SERIALIZED_NAME_NFA_REGISTRATION_NUMBER)
  @javax.annotation.Nullable
  private String nfaRegistrationNumber;

  public TrusteeIndividual() {
  }

  public TrusteeIndividual name(@javax.annotation.Nullable IndividualName name) {
    this.name = name;
    return this;
  }
  ...
  public TrusteeIndividual nativeName(@javax.annotation.Nullable IndividualName nativeName) {
  ...
  public TrusteeIndividual birthName(@javax.annotation.Nullable IndividualName birthName) {
  ...
  public TrusteeIndividual motherMaidenName(@javax.annotation.Nullable IndividualName motherMaidenName) {
  ...
  public TrusteeIndividual dateOfBirth(@javax.annotation.Nullable String dateOfBirth) {
  ...
  public TrusteeIndividual countryOfBirth(@javax.annotation.Nullable String countryOfBirth) {
  ...
  public TrusteeIndividual cityOfBirth(@javax.annotation.Nullable String cityOfBirth) {
  ...
  public TrusteeIndividual gender(@javax.annotation.Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public TrusteeIndividual maritalStatus(@javax.annotation.Nullable MaritalStatusEnum maritalStatus) {
  ...
  public TrusteeIndividual numDependents(@javax.annotation.Nullable Integer numDependents) {
  ...
  public TrusteeIndividual residenceAddress(@javax.annotation.Nullable ResidenceAddress residenceAddress) {
  ...
  public TrusteeIndividual mailingAddress(@javax.annotation.Nullable Address mailingAddress) {
  ...
  public TrusteeIndividual phones(@javax.annotation.Nullable List<PhoneInfo> phones) {
    this.phones = phones;
    return this;
  }

  public TrusteeIndividual addPhonesItem(PhoneInfo phonesItem) {
    if (this.phones == null) {
  ...
  public TrusteeIndividual email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public TrusteeIndividual identification(@javax.annotation.Nullable Identification identification) {
  ...
  public TrusteeIndividual employmentType(@javax.annotation.Nullable String employmentType) {
  ...
  public TrusteeIndividual employmentDetails(@javax.annotation.Nullable EmploymentDetails employmentDetails) {
  ...
  public TrusteeIndividual employeeTitle(@javax.annotation.Nullable String employeeTitle) {
  ...
  public TrusteeIndividual taxResidencies(@javax.annotation.Nullable List<TaxResidency> taxResidencies) {
    this.taxResidencies = taxResidencies;
    return this;
  }

  public TrusteeIndividual addTaxResidenciesItem(TaxResidency taxResidenciesItem) {
  ...
  public TrusteeIndividual w9(@javax.annotation.Nullable FormW9 w9) {
    this.w9 = w9;
    return this;
  }
  ...
  public TrusteeIndividual w8Ben(@javax.annotation.Nullable FormW8BEN w8Ben) {
    this.w8Ben = w8Ben;
    return this;
  }
  ...
  public TrusteeIndividual crs(@javax.annotation.Nullable FormCRS crs) {
    this.crs = crs;
    return this;
  }
  ...
  public TrusteeIndividual prohibitedCountryQuestionnaire(@javax.annotation.Nullable ProhibitedCountryQuestionnaireList prohibitedCountryQuestionnaire) {
  ...
  public TrusteeIndividual id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public TrusteeIndividual externalId(@javax.annotation.Nullable String externalId) {
  ...
  public TrusteeIndividual userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public TrusteeIndividual sameMailAddress(@javax.annotation.Nullable Boolean sameMailAddress) {
  ...
  public TrusteeIndividual authorizedToSignOnBehalfOfOwner(@javax.annotation.Nullable Boolean authorizedToSignOnBehalfOfOwner) {
  ...
  public TrusteeIndividual authorizedTrader(@javax.annotation.Nullable Boolean authorizedTrader) {
  ...
  public TrusteeIndividual usTaxResident(@javax.annotation.Nullable Boolean usTaxResident) {
  ...
  public TrusteeIndividual translated(@javax.annotation.Nullable Boolean translated) {
  ...
  public TrusteeIndividual primaryTrustee(@javax.annotation.Nullable Boolean primaryTrustee) {
  ...
  public TrusteeIndividual nfaRegistered(@javax.annotation.Nullable Boolean nfaRegistered) {
    this.nfaRegistered = nfaRegistered;
    return this;
  }

  /**
   * Get nfaRegistered
   * @return nfaRegistered
   */
  @javax.annotation.Nullable
  public Boolean getNfaRegistered() {
    return nfaRegistered;
  }

  public void setNfaRegistered(@javax.annotation.Nullable Boolean nfaRegistered) {
    this.nfaRegistered = nfaRegistered;
  }


  public TrusteeIndividual nfaRegistrationNumber(@javax.annotation.Nullable String nfaRegistrationNumber) {
    this.nfaRegistrationNumber = nfaRegistrationNumber;
    return this;
  }

  /**
   * Get nfaRegistrationNumber
   * @return nfaRegistrationNumber
   */
  @javax.annotation.Nullable
  public String getNfaRegistrationNumber() {
    return nfaRegistrationNumber;
  }

  public void setNfaRegistrationNumber(@javax.annotation.Nullable String nfaRegistrationNumber) {
    this.nfaRegistrationNumber = nfaRegistrationNumber;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrusteeIndividual trusteeIndividual = (TrusteeIndividual) o;
    return Objects.equals(this.name, trusteeIndividual.name) &&
        Objects.equals(this.nativeName, trusteeIndividual.nativeName) &&
        Objects.equals(this.birthName, trusteeIndividual.birthName) &&
        Objects.equals(this.motherMaidenName, trusteeIndividual.motherMaidenName) &&
        Objects.equals(this.dateOfBirth, trusteeIndividual.dateOfBirth) &&
        Objects.equals(this.countryOfBirth, trusteeIndividual.countryOfBirth) &&
        Objects.equals(this.cityOfBirth, trusteeIndividual.cityOfBirth) &&
        Objects.equals(this.gender, trusteeIndividual.gender) &&
        Objects.equals(this.maritalStatus, trusteeIndividual.maritalStatus) &&
        Objects.equals(this.numDependents, trusteeIndividual.numDependents) &&
        Objects.equals(this.residenceAddress, trusteeIndividual.residenceAddress) &&
        Objects.equals(this.mailingAddress, trusteeIndividual.mailingAddress) &&
        Objects.equals(this.phones, trusteeIndividual.phones) &&
        Objects.equals(this.email, trusteeIndividual.email) &&
        Objects.equals(this.identification, trusteeIndividual.identification) &&
        Objects.equals(this.employmentType, trusteeIndividual.employmentType) &&
        Objects.equals(this.employmentDetails, trusteeIndividual.employmentDetails) &&
        Objects.equals(this.employeeTitle, trusteeIndividual.employeeTitle) &&
        Objects.equals(this.taxResidencies, trusteeIndividual.taxResidencies) &&
        Objects.equals(this.w9, trusteeIndividual.w9) &&
        Objects.equals(this.w8Ben, trusteeIndividual.w8Ben) &&
        Objects.equals(this.crs, trusteeIndividual.crs) &&
        Objects.equals(this.prohibitedCountryQuestionnaire, trusteeIndividual.prohibitedCountryQuestionnaire) &&
        Objects.equals(this.id, trusteeIndividual.id) &&
        Objects.equals(this.externalId, trusteeIndividual.externalId) &&
        Objects.equals(this.userId, trusteeIndividual.userId) &&
        Objects.equals(this.sameMailAddress, trusteeIndividual.sameMailAddress) &&
        Objects.equals(this.authorizedToSignOnBehalfOfOwner, trusteeIndividual.authorizedToSignOnBehalfOfOwner) &&
        Objects.equals(this.authorizedTrader, trusteeIndividual.authorizedTrader) &&
        Objects.equals(this.usTaxResident, trusteeIndividual.usTaxResident) &&
        Objects.equals(this.translated, trusteeIndividual.translated) &&
        Objects.equals(this.primaryTrustee, trusteeIndividual.primaryTrustee) &&
        Objects.equals(this.nfaRegistered, trusteeIndividual.nfaRegistered) &&
        Objects.equals(this.nfaRegistrationNumber, trusteeIndividual.nfaRegistrationNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, nativeName, birthName, motherMaidenName, dateOfBirth, countryOfBirth, cityOfBirth, gender, maritalStatus, numDependents, residenceAddress, mailingAddress, phones, email, identification, employmentType, employmentDetails, employeeTitle, taxResidencies, w9, w8Ben, crs, prohibitedCountryQuestionnaire, id, externalId, userId, sameMailAddress, authorizedToSignOnBehalfOfOwner, authorizedTrader, usTaxResident, translated, primaryTrustee, nfaRegistered, nfaRegistrationNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrusteeIndividual {\n");
    ...
    sb.append("    nfaRegistered: ").append(toIndentedString(nfaRegistered)).append("\n");
    sb.append("    nfaRegistrationNumber: ").append(toIndentedString(nfaRegistrationNumber)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("nfaRegistered");
    openapiFields.add("nfaRegistrationNumber");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TrusteeIndividual
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TrusteeIndividual.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrusteeIndividual is not found in the empty JSON string", TrusteeIndividual.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TrusteeIndividual.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrusteeIndividual` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("nfaRegistrationNumber") != null && !jsonObj.get("nfaRegistrationNumber").isJsonNull()) && !jsonObj.get("nfaRegistrationNumber").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nfaRegistrationNumber` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nfaRegistrationNumber").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrusteeIndividual.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrusteeIndividual' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrusteeIndividual> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrusteeIndividual.class));

       return (TypeAdapter<T>) new TypeAdapter<TrusteeIndividual>() {
           @Override
           public void write(JsonWriter out, TrusteeIndividual value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrusteeIndividual read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TrusteeIndividual given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TrusteeIndividual
   * @throws IOException if the JSON string is invalid with respect to TrusteeIndividual
   */
  public static TrusteeIndividual fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrusteeIndividual.class);
  }

  /**
   * Convert an instance of TrusteeIndividual to an JSON string
   *
   * @return JSON string
   */
