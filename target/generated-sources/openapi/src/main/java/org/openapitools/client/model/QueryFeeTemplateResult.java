...
public class QueryFeeTemplateResult {
  ...
  private Object templateDetails;
  ...
  public QueryFeeTemplateResult() {
  }

  public QueryFeeTemplateResult templateDetails(@javax.annotation.Nonnull Object templateDetails) {
  ...
  public void setTemplateDetails(@javax.annotation.Nonnull Object templateDetails) {
    this.templateDetails = templateDetails;
  }


  public QueryFeeTemplateResult clientInstructionId(@javax.annotation.Nonnull String clientInstructionId) {
  ...
  public QueryFeeTemplateResult instructionType(@javax.annotation.Nonnull InstructionTypeEnum instructionType) {
  ...
  public QueryFeeTemplateResult instructionStatus(@javax.annotation.Nonnull InstructionStatusEnum instructionStatus) {
  ...
  public QueryFeeTemplateResult instructionId(@javax.annotation.Nonnull BigDecimal instructionId) {
  ...
  public QueryFeeTemplateResult ibReferenceId(@javax.annotation.Nullable BigDecimal ibReferenceId) {
  ...
  public QueryFeeTemplateResult description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    QueryFeeTemplateResult queryFeeTemplateResult = (QueryFeeTemplateResult) o;
    return Objects.equals(this.templateDetails, queryFeeTemplateResult.templateDetails) &&
        Objects.equals(this.clientInstructionId, queryFeeTemplateResult.clientInstructionId) &&
        Objects.equals(this.instructionType, queryFeeTemplateResult.instructionType) &&
        Objects.equals(this.instructionStatus, queryFeeTemplateResult.instructionStatus) &&
        Objects.equals(this.instructionId, queryFeeTemplateResult.instructionId) &&
        Objects.equals(this.ibReferenceId, queryFeeTemplateResult.ibReferenceId) &&
        Objects.equals(this.description, queryFeeTemplateResult.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(templateDetails, clientInstructionId, instructionType, instructionStatus, instructionId, ibReferenceId, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QueryFeeTemplateResult {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("templateDetails");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryFeeTemplateResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryFeeTemplateResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryFeeTemplateResult is not found in the empty JSON string", QueryFeeTemplateResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryFeeTemplateResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryFeeTemplateResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : QueryFeeTemplateResult.openapiRequiredFields) {
        if (jsonElement.getAsJsonObject().get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the required field `templateDetails`
      Object.validateJsonElement(jsonObj.get("templateDetails"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryFeeTemplateResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryFeeTemplateResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryFeeTemplateResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryFeeTemplateResult.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryFeeTemplateResult>() {
           @Override
           public void write(JsonWriter out, QueryFeeTemplateResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryFeeTemplateResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryFeeTemplateResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryFeeTemplateResult
   * @throws IOException if the JSON string is invalid with respect to QueryFeeTemplateResult
   */
  public static QueryFeeTemplateResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryFeeTemplateResult.class);
  }

  /**
   * Convert an instance of QueryFeeTemplateResult to an JSON string
   *
   * @return JSON string
   */
