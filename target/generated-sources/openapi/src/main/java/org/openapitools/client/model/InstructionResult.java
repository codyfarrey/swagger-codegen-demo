...
public class InstructionResult {
  ...
  public InstructionResult clientInstructionId(@javax.annotation.Nonnull String clientInstructionId) {
  ...
  public InstructionResult instructionType(@javax.annotation.Nonnull InstructionTypeEnum instructionType) {
  ...
  public InstructionResult instructionStatus(@javax.annotation.Nonnull InstructionStatusEnum instructionStatus) {
  ...
  public InstructionResult instructionId(@javax.annotation.Nonnull BigDecimal instructionId) {
  ...
  public InstructionResult ibReferenceId(@javax.annotation.Nullable BigDecimal ibReferenceId) {
  ...
  public InstructionResult description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    InstructionResult instructionResult = (InstructionResult) o;
    return Objects.equals(this.clientInstructionId, instructionResult.clientInstructionId) &&
        Objects.equals(this.instructionType, instructionResult.instructionType) &&
        Objects.equals(this.instructionStatus, instructionResult.instructionStatus) &&
        Objects.equals(this.instructionId, instructionResult.instructionId) &&
        Objects.equals(this.ibReferenceId, instructionResult.ibReferenceId) &&
        Objects.equals(this.description, instructionResult.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientInstructionId, instructionType, instructionStatus, instructionId, ibReferenceId, description);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InstructionResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InstructionResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InstructionResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstructionResult is not found in the empty JSON string", InstructionResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InstructionResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InstructionResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstructionResult.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstructionResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstructionResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstructionResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstructionResult.class));

       return (TypeAdapter<T>) new TypeAdapter<InstructionResult>() {
           @Override
           public void write(JsonWriter out, InstructionResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InstructionResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InstructionResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InstructionResult
   * @throws IOException if the JSON string is invalid with respect to InstructionResult
   */
  public static InstructionResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstructionResult.class);
  }

  /**
   * Convert an instance of InstructionResult to an JSON string
   *
   * @return JSON string
   */
